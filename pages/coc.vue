...
<template>
  <div class="page--coc container--white">
    ...
    <p>
      En cas souci, merci de vous diriger vers <a href="https://touraine.tech/#team">un membre de l'équipe d'organisation</a> en sweat vert.
    </p>
    ...
    <div class="footer">
      <p>
        <small>
          <em>
            Texte repris depuis <a href="https://confcodeofconduct.com/index-fr.html">confcodeofconduct.com</a>
