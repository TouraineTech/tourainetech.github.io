...
const feedbackUrl = computed(() => {
  ...
  return `https://openfeedback.io/${OPENFEEDBACK_EVENT_ID}/${date}/${rawTalk.value.id}?hideHeader=true&forceColorScheme=light`
})
...
<template>
  <div v-if="talk" class="container--fix">
    ...
    <div v-if="feedbackUrl" class="feedback-embed">
      <h2>Donner votre avis</h2>
      <iframe
        :src="feedbackUrl"
        class="feedback-embed__iframe"
        frameborder="0"
